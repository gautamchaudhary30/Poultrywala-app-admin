        ...
        <div className="flex flex-col gap-y-4">
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                <div className="card">
                    ...
                    <div className="w-fit rounded-lg bg-[rgba(78,138,5,0.2)] p-2 text-[#4E8A05] transition-colors dark:bg-[rgba(78,138,5,0.2)] dark:text-[#4E8A05]">
                    ...
                    <div className="card-body bg-slate-100 transition-colors dark:bg-slate-950">
                        ...
                        <span className="flex w-fit items-center gap-x-2 rounded-full border border-[#4E8A05] px-2 py-1 font-medium text-[#4E8A05] dark:border-[#4E8A05] dark:text-[#4E8A05]
">
                            <TrendingUp size={18} />
                            25%
                        </span>
                ...
                <div className="card">
                    <div className="card-header">
                        <div className="rounded-lg bg-[rgba(78,138,5,0.2)] p-2 text-[#4E8A05] transition-colors dark:bg-[rgba(78,138,5,0.2)] dark:text-[#4E8A05]">
                            <DollarSign size={26} />
                        </div>
                        ...
                        <table className="table">
                            <thead className="table-header">
                                <tr className="table-row">
                                    ...
                                    <th className="table-head">Trader Name</th>
                                    <th className="table-head">Order Quantity</th>
